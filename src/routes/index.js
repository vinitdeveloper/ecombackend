...
// logo file included
const LogoApp = React.lazy(() => import('../pages/apps/Logo/EditLogo'));

// Top and Bottom Banner file included
const TopBannerApp = React.lazy(() => import('../pages/apps/Banner/EditTopBanner'))
const BottomBannerApp = React.lazy(() => import('../pages/apps/Banner/EditBottomBanner'))

// Deal Banner file included
const DealApp = React.lazy(() => import('../pages/apps/Banner/EditDealBanner'));

// discount file included
const DiscountApp = React.lazy(() => import('../pages/apps/Discount/Discount'));
const AddDiscountApp = React.lazy(() => import('../pages/apps/Discount/AddDiscount'));
const EditDiscountApp = React.lazy(() => import('../pages/apps/Discount/EditDiscount'));

// slider file included
const SliderApp = React.lazy(() => import('../pages/apps/Slider/Sliders'));
const AddSliderApp = React.lazy(() => import('../pages/apps/Slider/AddSlider'));
const EditSliderApp = React.lazy(() => import('../pages/apps/Slider/EditSlider'));

// category file included
const CategoryApp = React.lazy(() => import('../pages/apps/Category/Categories'));
const AddCategoryApp = React.lazy(() => import('../pages/apps/Category/AddCategory'));
const EditCategoryApp = React.lazy(() => import('../pages/apps/Category/EditCategory'));

// subcategory file included
const SubcategoryApp = React.lazy(() => import('../pages/apps/Subcategory/Subcategories'));
const AddSubcategoryApp = React.lazy(() => import('../pages/apps/Subcategory/AddSubcategory'));
const EditSubcategoryApp = React.lazy(() => import('../pages/apps/Subcategory/EditSubcategory'));

// user file included
const UserApp = React.lazy(() => import('../pages/apps/User/User'));
const AddUserApp = React.lazy(() => import('../pages/apps/User/AddUser'));
const EditUserApp = React.lazy(() => import('../pages/apps/User/EditUser'));

// - ecommece pages
const EcommerceProducts = React.lazy(() => import('../pages/apps/Ecommerce/Products'));
const AddEcommerceProducts = React.lazy(() => import('../pages/apps/Ecommerce/AddProduct'));
const EditEcommerceProducts = React.lazy(() => import('../pages/apps/Ecommerce/EditProduct'));
const ProductDetails = React.lazy(() => import('../pages/apps/Ecommerce/ProductDetails'));
const Orders = React.lazy(() => import('../pages/apps/Ecommerce/Orders'));
const EditOrder = React.lazy(() => import('../pages/apps/Ecommerce/EditOrder'));
...
const CustomRoute = React.lazy(() => import('../pages/GoogleMapsCustom'));
...
const discountAppRoutes = {
    ...
    children: [
        ...
        },
        {
            path: '/apps/addcoupon',
            name: 'Add Coupon',
			component: AddDiscountApp,
            route: PrivateRoute,
        },
		{
            path: '/apps/editcoupon/:id',
			component: EditDiscountApp,
            route: PrivateRoute,
        },
    ],
};

const catesubAppRoutes = {
    path: '/apps/category',
    ...
    children: [
        ...
        // {
        //     path: '/apps/addsubcategory',
        //     name: 'Add Subcategory',
        //     component: AddSubcategoryApp,
        //     route: PrivateRoute,
        // },
        {
            path: '/apps/editcategory/:id',
			component: EditCategoryApp,
            route: PrivateRoute,
        },
		{
            path: '/apps/editsubcategory/:id',
            component: EditSubcategoryApp,
            route: PrivateRoute,
        },
    ],
};

const categoryAppRoutes = {
    path: '/apps/category',
...
const bannersAppRoutes = {
    path: '/apps/top-banner',
    name: 'Banners',
    route: PrivateRoute,
    roles: ['Admin'],
    icon: 'uil-store',
    children: [
        {
            path: '/apps/top-banner',
            name: 'Top Banner',
            component: TopBannerApp,
            route: PrivateRoute,
        },
        {
            path: '/apps/bottom-banner',
            name: 'Bottom Banner',
			component: BottomBannerApp,
            route: PrivateRoute,
        },
    ],
};
...
const sliderAppRoutes = {
    ...
    children: [
        ...
        //     path: '/apps/addslider',
        //     name: 'Add Slider',
		// 	component: AddSliderApp,
        //     route: PrivateRoute,
        // },
		{
            path: '/apps/editslider/:id',
			component: EditSliderApp,
            route: PrivateRoute,
        },
    ],
};
...
const ecommerceAppRoutes = {
    ...
    children: [
        ...
        },
        {
            ...
            name: 'Add Product',
            component: AddEcommerceProducts,
            route: PrivateRoute,
        },
        {
            path: '/apps/editproduct/:id',
            component: EditEcommerceProducts,
            route: PrivateRoute,
        },
        {
...
const appRoutes = [
    ...
    chatAppRoutes,
    // taskAppRoutes,
	{ path: '/wtertweyrtwertw', component: CustomRoute, route: PrivateRoute, roles: ['Admin'] }
];
