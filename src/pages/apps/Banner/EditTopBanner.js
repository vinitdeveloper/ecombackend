...
class EditTopBanner extends React.Component {
    ...
    handleSubmitUpdate(event, data, values) {
        ...
        axios.put('update-topbanner', bodyFormData)
        .then(function (response) {
                        ...
                        <Card>
                            <CardBody>
                                ...
                                <AvForm onValidSubmit={this.handleSubmitUpdate}>
									...
									<AvField name="title" value={this.state.title} label="Banner Title Image Size : 380 x 190 (PX)" type="text" required/>
									
									<AvField name="banner" label="Banner Image" type="file" required/>
