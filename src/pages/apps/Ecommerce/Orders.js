...
const Orders = () => {
	...
	const OrderPriceColumn = (cell, row, rowIndex, extraData) => {
        return (
            <React.Fragment>
                $ {row.grand_total}
            </React.Fragment>
        ...
        return (
            <React.Fragment>
                <h5>
                    <span
                        className={classNames('badge', {
                            'badge-danger-lighten': cell === 3,
                            'badge-success-lighten': cell === 2,
                            'badge-info-lighten': cell === 1,
                            'badge-warning-lighten': cell === 0,
                        })}>
                        {cell === 0 ? "Pending" : ""}
                        {cell === 1 ? "Processing" : ""}
                        {cell === 2 ? "Completed" : ""}
    ...
    const ActionColumn = (cell, row, rowIndex, extraData) => {
        return (
            <React.Fragment>
                ...
                <Link to={`/apps/editorder/${row.o_id}`} className="action-icon">
                    {' '}
