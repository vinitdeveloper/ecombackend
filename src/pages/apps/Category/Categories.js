  ...
  const fetchCategories = () => {
    ...
    const ActionColumn = (cell, row, rowIndex, extraData) => {
        ...
        function handleClick(e,rowId) {
            ...
            axios.delete(`delete-category/${rowId}`)
        ...
        return (
            <React.Fragment>
                <Link to={`/apps/editcategory/${row.id}`} className="action-icon">
                    {' '}
    ...
    return (
        <React.Fragment>
            <PageTitle
                breadCrumbItems={[
                    { label: 'Categories', path: '/apps/category', active: true },
                ]}
                title={'Categories'}
            />
                        ...
                        <CardBody>
                            <Row>
                                <Col sm={4}>
									...
									{/* <Link to="/apps/addcategory" className="action-icon">
