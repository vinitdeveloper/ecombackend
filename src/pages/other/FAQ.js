...
const FAQ = () => {
    ...
    const rawFaqs2 = [
        ...
        {
            id: 4,
            question: 'Will you regularly give updates of RETAILER?',
            answer:
                'Yes, We will update the RETAILER regularly. All the future updates would be available without any cost',
        },
    ];
